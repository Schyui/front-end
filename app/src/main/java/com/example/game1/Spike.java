...
public class Spike {
    ...
    public Spike(Context context){
        ...
        spike[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.spike2);
        spike[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.spike3);
        random = new Random();
        resetPosition();
    }
